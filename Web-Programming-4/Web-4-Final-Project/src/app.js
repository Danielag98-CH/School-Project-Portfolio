...
app.use("/supplier", require("./supplier/supplier.routes"));
app.use("/ingredient", require("./ingredient/ingredient.routes"));
app.use("/soap", require("./soap/soap.routes"));
app.use("/soap-ingredient", require("./soap-ingredient/soap.ingredient.routes"));
