...
describe("User Data Service", ()=>{
  ...
  describe("insert()", () => {
    ...
    it("should return id greater than 0 on successful insert", async () => {
      const userToInsert = new User({"firstName":"Lu","lastName":"Smith","email":"xxxx@xxxx.com","roleId":2,"active":true, password: "xxxxxxxx"})
    ...
    it("should throw error if the email is already in the database", async () => {
      const userToInsert = new User({"firstName":"x","lastName":"x","email":"daniela.gonzalez@gmail.com","roleId":2,"active":true, password: "wedding8"})
  ...
  describe("remove()", () => {
    ...
    it("should return true on successful delete", async () => {
      ...
      const userToInsert = new User({"firstName":"Buster","lastName":"Smith","email":"buster@smith.com","roleId":2,"active":true, password: "xxxxxxxx"})
      const userId = await insert(userToInsert);
